      ...
      {loader == true ? (
        ...
        <>
          <span className="p-1 text-center font-semibold shadow-md">
            <p>{userreginfo?.status.message}</p>
          </span>
          <div className="flex flex-col justify-around gap-5 border shadow-md w-max h-max p-4">
              ...
              >
                <span className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    type="text"
                    name="firstname"
                    value={userreginfo?.user.firstname.toString()}
                    onChange={userreginfo?.handleChange}
                  />
                </span>
                <span className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    type="text"
                    name="lastname"
                    value={userreginfo?.user.lastname.toString()}
                    onChange={userreginfo?.handleChange}
                  />
                </span>
                <span className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    type="text"
                    name="email"
                    value={userreginfo?.user.email.toString()}
                    onChange={userreginfo?.handleChange}
                  />
                </span>
                <span className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    type="password"
                    name="user_password"
                    value={userreginfo?.user.user_password.toString()}
                    onChange={userreginfo?.handleChange}
                  />
                </span>
                <span className="flex flex-col gap-1">
                  ...
                  <input
                    ...
                    value={userreginfo?.user.confirm_password.toString()}
                    onChange={userreginfo?.handleChange}
                  />
                </span>
              </form>
            ...
            <div className="text-center">
              <button
                className="bg-indigo-600 w-[35vw] shadow-md rounded-sm p-2 text-md font-semibold text-white"
                onClick={(e) => {
                  userreginfo?.handleSubmit(e);
                  setLoader(!loader);
                }}
              >
                Register
