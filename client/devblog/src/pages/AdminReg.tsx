  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch(
        "https://devblog-kr5o.onrender.com" + "/admin/register",
        {
          method: "POST",
  ...
  return (
    <div className="h-[100vh] w-[100vw] flex flex-col gap-2 items-center justify-center mt-2">
      ...
      <div className="flex flex-col justify-around gap-5 border shadow-md w-max h-max p-4">
        <div className="text-2xl text-indigo-600 font-semibold mt-1">
          ...
          <form method="POST" className="flex gap-3 flex-col justify-center">
            ...
            <span className="flex flex-col gap-1">
              ...
              <input
                ...
                type="password"
                name="admin_password"
                value={user.admin_password.toString()}
                onChange={handleChange}
              />
            </span>
            <span className="flex flex-col gap-1">
              ...
              <input
                ...
                value={user.confirm_password.toString()}
                onChange={handleChange}
              />
            </span>
            <span className="flex flex-col gap-1">
              ...
              <input
                ...
                type="text"
                name="activation_key"
                value={user.activation_key.toString()}
                onChange={handleChange}
              />
            </span>
          </form>
