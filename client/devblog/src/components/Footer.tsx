  ...
  return (
    <div className="mt-auto shadow-md border p-3 flex flex-col justify-evenly items-center h-max w-[100vw]">
      <div className="flex md:flex-row flex-col gap-3 items-center justify-between w-[100vw] px-8">
        <h1 className="logo text-xl font-semibold">
          <Link to="/">
      ...
      <div className="w-max h-max flex flex-row items-center mt-5 gap-6">
        <a href="">
          <Icon
            className="shadow-xl cursor-pointer hover:shadow-2xl transition duration-300 ease-in-out transform hover:-translate-y+1 hover:scale-105"
            height="3vh"
            icon="mdi:github"
          />
        </a>
      ...
      <div className="flex md:flex-row flex-col w-screen h-max items-center justify-center gap-1 mt-3">
        <h1 className="logo text-sm font-semibold">
          <Link to="/">
            Dev<span className="text-indigo-600">Blog</span>
          </Link>
        </h1>
        <p className="flex md:flex-row flex-col justify-center gap-1 text-center w-max font-medium">
